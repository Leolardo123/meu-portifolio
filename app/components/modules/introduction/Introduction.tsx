    ...
    <section id="introduction">
      <div className="inner-section">
        ...
        <p className="section-paragraph">
          ...
          organizado, escalável e de fácil manutenção. 
          Atualmente venho
          expandindo meus conhecimentos em Next.js e desenvolvendo projetos
          pessoais para explorar diferentes arquiteturas, padrões de
