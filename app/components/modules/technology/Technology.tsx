...
export default function Technology() {
  return (
    <section id="technology" className="bg-secondary-3 text-(--font-dark) px-25 py-15 lg:px-75.5">
      ...
      <div id="technology-details">
        <div id="technology-list" className="grid grid-cols-1 sm:grid-cols-2 mt-12.25">
